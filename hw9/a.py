...
def main():
    # 讀取圖片
    img1 = cv2.imread('hw9/images/camera_calibration_images/0.jpg')
    img2 = cv2.imread('hw9/images/camera_calibration_images/1.jpg')
    ...
    ret2, corners2 = cv2.findChessboardCorners(gray2, CHECKERBOARD,
                                             cv2.CALIB_CB_ADAPTIVE_THRESH +
                                             cv2.CALIB_CB_FAST_CHECK +
                                             cv2.CALIB_CB_NORMALIZE_IMAGE)
    ...
    if ret1 and ret2:
        ...
        # 轉換角點格式
        points1 = corners1.reshape(-1, 2)
        points2 = corners2.reshape(-1, 2)
